...
const TermsOfUse = () => {
    ...
    return (
        <div className='termsofuse'>
            <div className='head'>
                <h1>TERMS OF USE</h1>
                <p>Last updated December 05, 2021</p>
            </div>
            <div className='table'>
                <h3>TABLE OF CONTENTS</h3>
                <ol>
                    <a href="#agreement"><li>AGREEMENT TO TERMS</li></a>
                    <a href="#intellectual"><li>INTELLECTUAL PROPERTY RIGHTS</li></a>
                    <a href="#representations"><li>USER REPRESENTATIONS</li></a>
                    <a href="#registration"><li>USER REGISTRATION</li></a>
                    <a href="#prohibited"><li>PROHIBITED ACTIVITIES</li></a>
                    <a href="#contributions"><li>USER GENERATED CONTRIBUTIONS</li></a>
                    <a href="#license"><li>CONTRIBUTION LICENSE</li></a>
                    <a href="#guidelines"><li>GUIDELINES FOR REVIEWS</li></a>
                    <a href="#socmed"><li>SOCIAL MEDIA</li></a>
                    <a href="#submissions"><li>SUBMISSIONS</li></a>
                    <a href="#site"><li>SITE MANAGEMENT</li></a>
                    <a href="#termination"><li>TERM AND TERMINATION</li></a>
                    <a href="#interruptions"><li>MODIFICATIONS AND INTERRUPTIONS</li></a>
                    <a href="#law"><li>GOVERNING LAW</li></a>
                    <a href="#dispute"><li>DISPUTE RESOLUTION</li></a>
                    <a href="#corrections"><li>CORRECTIONS</li></a>
                    <a href="#disclaimer"><li>DISCLAIMER</li></a>
                    <a href="#limitations"><li>LIMITATIONS OF LIABILITY</li></a>
                    <a href="#indemnification"><li>INDEMNIFICATION</li></a>
                    <a href="#data"><li>USER DATA</li></a>
                    <a href="#electronic"><li>ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</li></a>
                    <a href="#miscellaneous"><li>MISCELLANEOUS</li></a>
            ...
            <ol className="terms">
                <li>
                    ...
                    <div className="term-content">
                        <p>These Terms of Use constitute a legally binding agreement made between you, whether personally or on behalf of an entity (“you”) and Drinkerage, LLC. ("Company," “we," “us," or “our”), concerning your access to and use of the __________ website as well as any other media form, media channel, mobile website or mobile application related, linked, or otherwise connected thereto (collectively, the “Site”). We are registered in the Philippines and have our registered office at __________, Tacloban, Leyte 6500. You agree that by accessing the Site, you have read, understood, and agreed to be bound by all of these Terms of Use. IF YOU DO NOT AGREE WITH ALL OF THESE TERMS OF USE, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SITE AND YOU MUST DISCONTINUE USE IMMEDIATELY.<br /><br />
                ...
                <li>
                    <h3 id="intellectual">INTELLECTUAL PROPERTY RIGHTS</h3>
                    <div className="term-content">
                        ...
                        Provided that you are eligible to use the Site, you are granted a limited license to access and use the Site and to download or print a copy of any portion of the Content to which you have properly gained access solely for your personal, non-commercial use. We reserve all rights not expressly granted to you in and to the Site, the Content and the Marks.<br /><br /></p>
                    </div>
                </li>
                <li>
                    <h3 id="representations">USER REPRESENTATIONS</h3>
                    <div className="term-content">
                        <p>By using the Site, you represent and warrant that: (1) all registration information you submit will be true, accurate, current, and complete; (2) you will maintain the accuracy of such information and promptly update such registration information as necessary; (3) you have the legal capacity and you agree to comply with these Terms of Use; (4) you are not a minor in the jurisdiction in which you reside; (5) you will not access the Site through automated or non-human means, whether through a bot, script, or otherwise; (6) you will not use the Site for any illegal or unauthorized purpose; and (7) your use of the Site will not violate any applicable law or regulation.<br /><br />
                ...
                <li>
                    <h3 id="prohibited">PROHIBITED ACTIVITIES</h3>
                    <div className="term-content">
                        ...
                        As a user of the Site, you agree not to:<br /></p>
                        <ul>
                ...
                <li>
                    <h3 id="contributions">USER GENERATED CONTRIBUTIONS</h3>
                    <div className="term-content">
                ...
                <li>
                    <h3 id="license">CONTRIBUTION LICENSE</h3>
                    <div className="term-content">
                        <p>You and the Site agree that we may access, store, process, and use any information and personal data that you provide following the terms of the Privacy Policy and your choices (including settings).<br /><br />
                ...
                <li>
                    <h3 id="guidelines">GUIDELINES FOR REVIEWS</h3>
                    <div className="term-content">
                ...
                <li>
                    ...
                    <div className="term-content">
                        ...
                        We will attempt to delete any information stored on our servers that was obtained through such Third-Party Account, except the username and profile picture that become associated with your account.</p>
                    </div>
                </li>
                <li>
                ...
                <li>
                    <h3 id="termination">TERM AND TERMINATION</h3>
                    <div className="term-content">
                ...
                <li>
                    <h3 id="interruptions">MODIFICATIONS AND INTERRUPTIONS</h3>
                    <div className="term-content">
                        <p>We reserve the right to change, modify, or remove the contents of the Site at any time or for any reason at our sole discretion without notice. However, we have no obligation to update any information on our Site. We also reserve the right to modify or discontinue all or part of the Site without notice at any time. We will not be liable to you or any third party for any modification, price change, suspension, or discontinuance of the Site.<br /><br />
                ...
                <li>
                    ...
                    <div className="term-content">
                        <p>These Terms shall be governed by and defined following the laws of the Philippines. Drinkerage, LLC. and yourself irrevocably consent that the courts of the Philippines shall have exclusive jurisdiction to resolve any dispute which may arise in connection with these terms.</p>
                    </div>
                </li>
                <li>
                    <h3 id="dispute">DISPUTE RESOLUTION</h3>
                    <div className="term-content">
                        <ul>
                            <li>
                            ...
                            <li>
                                ...
                                <p>Any dispute arising out of or in connection with this contract, including any question regarding its existence, validity, or termination, shall be referred to and finally resolved by the International Commercial Arbitration Court under the European Arbitration Chamber (Belgium, Brussels, Avenue Louise, 146) according to the Rules of this ICAC, which, as a result of referring to it, is considered as the part of this clause. The number of arbitrators shall be two (2). The seat, or legal place, of arbitration shall be Tacloban, Philippines. The language of the proceedings shall be English. The governing law of the contract shall be the substantive law of the Philippines.</p>
                            </li>
                            <li>
                                <h3>Restrictions</h3>
                ...
                <li>
                    <h3 id="limitations">LIMITATIONS OF LIABILITY</h3>
                    <div className="term-content">
                ...
                <li>
                    ...
                    <div className="term-content">
                        ...
                        <div className="contact">
                            <p>Drinkerage, LLC.</p>
                            <p>Tacloban, Leyte 6500</p>
                            <p>Philippines</p>
                            <p>Phone: (+63) 966 560 9246</p>
                            <p>alecpayos.2020@gmail.com</p>
                        </div>
                    </div>
                </li>
            </ol>
