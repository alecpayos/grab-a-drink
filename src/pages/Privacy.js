    ...
    return (
        <div className="privacypolicy">
            ...
            <div className="head">
                ...
                <p>The purpose of this privacy notice is to explain to you in the clearest way possible what information we collect, how we use it, and what rights you have in relation to it. If there are any terms in this privacy notice that you do not agree with, please discontinue use of our Services immediately.<br /><br /></p>
                ...
                <h2 className='black'>TABLE OF CONTENTS</h2>
                <ol>
                    <a href="#whatcollect"><li>WHAT INFORMATION DO WE COLLECT?</li></a>
                    <a href="#howinfo"><li>HOW DO WE USE YOUR INFORMATION?</li></a>
                    <a href="#willanyone"><li>WILL YOUR INFORMATION BE SHARED WITH ANYONE?</li></a>
                    <a href="#dotech"><li>DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?</li></a>
                    <a href="#howlonginfo"><li>HOW LONG DO WE KEEP YOUR INFORMATION?</li></a>
                    <a href="#howsafe"><li>HOW DO WE KEEP YOUR INFORMATION SAFE?</li></a>
                    <a href="#dominors"><li>DO WE COLLECT INFORMATION FROM MINORS?</li></a>
                    <a href="#whatrights"><li>WHAT ARE YOUR PRIVACY RIGHTS?</li></a>
                    <a href="#controls"><li>CONTROLS FOR DO-NOT-TRACK FEATURES</li></a>
                    <a href="#dorights"><li>DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</li></a>
                    <a href="#donotice"><li>DO WE MAKE UPDATES TO THIS NOTICE?</li></a>
                    <a href="#hownotice"><li>HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</li></a>
                    <a href="#howreview"><li>HOW CAN YOU REVIEW, UPDATE OR DELETE THE DATA WE COLLECT FROM YOU?</li></a>
                </ol>
                <ol className='policies'>
                    <li>
                        <h2 id="whatcollect" className="black">WHAT INFORMATION DO WE COLLECT?</h2>
                        <strong className="black">Personal information you disclose to us</strong><br/><br />
                        <i><strong>In Short:</strong>  We collect personal information that you provide to us.</i>
                        <p>We collect personal information that you voluntarily provide to us when you register on the Website, express an interest in obtaining information about us or our products and Services, when you participate in activities on the Website or otherwise when you contact us.<br /><br />
                        The personal information that we collect depends on the context of your interactions with us and the Website, the choices you make and the products and features you use. The personal information we collect may include the following:<br /><br />
                        <strong>Personal Information Provided by You</strong>. We collect names; phone numbers; email addresses; usernames; passwords; contact preferences; contact or authentication data; billing addresses; debit/credit card numbers; and other similar information.<br /><br />
                        ...
                        <strong className="black">Information collected from other sources</strong><br /><br />
                        <i><strong>In Short:  </strong>We may collect limited data from public databases, marketing partners, and other outside sources.</i><br /><br />
                    ...
                    <li>
                        <h2 id="howinfo" className="black">HOW DO WE USE YOUR INFORMATION</h2>
                        <i><strong>In Short:  </strong>We process your information for purposes based on legitimate business interests, the fulfillment of our contract with you, compliance with our legal obligations, and/or your consent.</i><br />
                    ...
                    <li>
                        <h2 id="willanyone" className="black">WILL YOUR INFORMATION BE SHARED WITH ANYONE</h2>
                        <i><strong>In Short:  </strong>We only share information with your consent, to comply with laws, to provide you with services, to protect your rights, or to fulfill business obligations.</i><br /><br />
                    ...
                    <li>
                        <h2 id="dotech" className="black">DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES</h2>
                        <i><strong>In Short:  </strong>We may use cookies and other tracking technologies to collect and store your information.</i><br />
                        <p>We may use cookies and similar tracking technologies (like web beacons and pixels) to access or store information. Specific information about how we use such technologies and how you can refuse certain cookies is set out in our Cookie Notice.</p>
                    </li>
                    <li>
                        <h2 id="howlonginfo" className="black">HOW LONG DO WE KEEP YOUR INFORMATION</h2>
                        <i><strong>In Short:  </strong>We keep your information for as long as necessary to fulfill the purposes outlined in this privacy notice unless otherwise required by law.</i><br />
                    ...
                    <li>
                        <h2 id="howsafe" className="black">HOW DO WE KEEP YOUR INFORMATION SAFE</h2>
                    ...
                    <li>
                        <h2 id="dominors" className="black">DO WE COLLECT INFORMATION FROM MINORS</h2>
                    ...
                    <li>
                        <h2 id="whatrights" className="black">WHAT ARE YOUR PRIVACY RIGHTS</h2>
                        <i><strong>In Short:  </strong>In some regions, such as the European Economic Area (EEA) and United Kingdom (UK), you have rights that allow you greater access to and control over your personal information. You may review, change, or terminate your account at any time.</i>
                        <p>In some regions (like the EEA and UK), you have certain rights under applicable data protection laws. These may include the right (i) to request access and obtain a copy of your personal information, (ii) to request rectification or erasure; (iii) to restrict the processing of your personal information; and (iv) if applicable, to data portability. In certain circumstances, you may also have the right to object to the processing of your personal information. To make such a request, please use the <a href="#hownotice">contact details</a> provided below. We will consider and act upon any request in accordance with applicable data protection laws.<br /><br />
                        If we are relying on your consent to process your personal information, you have the right to withdraw your consent at any time. Please note however that this will not affect the lawfulness of the processing before its withdrawal, nor will it affect the processing of your personal information conducted in reliance on lawful processing grounds other than consent.<br /><br />
                        If you are a resident in the EEA or UK and you believe we are unlawfully processing your personal information, you also have the right to complain to your local data protection supervisory authority. You can find their contact details here: <a href="https://ec.europa.eu/newsroom/article29/items/612080/en">https://ec.europa.eu/justice/data-protection/bodies/authorities/index_en.htm</a>.<br /><br />
                        If you are a resident in Switzerland, the contact details for the data protection authorities are available here: <a href="https://www.edoeb.admin.ch/edoeb/en/home.html">https://www.edoeb.admin.ch/edoeb/en/home.html</a>.</p>
                        <strong className="black">Account Information</strong><br />
                    ...
                    <li>
                        <h2 id="controls" className="black">CONTROLS FOR DO-NOT-TRACK</h2>
                    ...
                    <li>
                        <h2 id="dorights" className="black">DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS</h2>
                        <i><strong>In Short:  </strong>Yes, if you are a resident of California, you are granted specific rights regarding access to your personal information.</i><br /><br />
                        ...
                        <strong className="black">CCPA Privacy Notice</strong><br /><br />
                        ...
                        <strong>What categories of personal information do we collect?</strong><br /><br />
                        We have collected the following categories of personal information in the past twelve (12) months:</p>
                        <table className="bordered">
                            <tr>
                                <th>Category</th>
                                <th>Examples</th>
                                <th className="middle">Collected</th>
                            </tr>
                            <tr>
                                <td>A. Identifiers</td>
                        ...
                        <p>We may also collect other personal information outside of these categories instances where you interact with us in-person, online, or by phone or mail in the context of:<br /><br />
                        <ul className="square">
                            <li>Receiving help through our customer support channels;</li>
                            <li>Participation in customer surveys or contests; and</li>
                            <li>Facilitation in the delivery of our Services and to respond to your inquiries.</li>
                        </ul><br />
                        <strong>How do we use and share your personal information?</strong><br /><br />
                        More information about our data collection and sharing practices can be found in this privacy notice.<br /><br />
                        You may contact us or by referring to the contact details at the bottom of this document.<br /><br />
                        ...
                        Drinkerage, LLC. has not disclosed or sold any personal information to third parties for a business or commercial purpose in the preceding 12 months. Drinkerage, LLC. will not sell personal information in the future belonging to website visitors, users and other consumers.<br /><br />
                        <strong>Your rights with respect to your personal data</strong><br /><br />
                        ...
                        To exercise these rights, you can contact us or by referring to the contact details at the bottom of this document. If you have a complaint about how we handle your data, we would like to hear from you.</p>
                    </li>
                    <li>
                        <h2 id="donotice" className="black">DO WE MAKE UPDATES TO THIS NOTICE</h2>
                        <p><i><strong>In Short:  </strong>Yes, we will update this notice as necessary to stay compliant with relevant laws.</i><br /><br />
                        We may update this privacy notice from time to time. The updated version will be indicated by an updated "Revised" date and the updated version will be effective as soon as it is accessible. If we make material changes to this privacy notice, we may notify you either by prominently posting a notice of such changes or by directly sending you a notification. We encourage you to review this privacy notice frequently to be informed of how we are protecting your information.</p>
                    </li>
                    <li>
                        <h2 id="hownotice" className="black">HOW CAN YOU CONTACT US ABOUT THIS NOTICE</h2>
                        <p>If you have questions or comments about this notice, you may email us at __________ or by post to:<br /><br />
                        Drinkerage, LLC.<br />
                        __________<br />
                        __________</p>
                    ...
                    <li>
                        <h2 id="howreview" className="black">HOW CAN YOU REVIEW, UPDATE OR DELETE THE DATA WE COLLECT FROM YOU</h2>
                        <p>Based on the applicable laws of your country, you may have the right to request access to the personal information we collect from you, change that information, or delete it in some circumstances. To request to review, update, or delete your personal information, please submit a request form by clicking <a href="https://app.termly.io/notify/218d1fd7-fa8d-4c31-a8b7-fb2a0a25bc4f">here</a>.</p>
                    </li>
                </ol>
            </div>
        </div>
